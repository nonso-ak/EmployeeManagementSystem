...
const ApplyLeavelModal = ({open, onClose, onSuccess}) => {
        ...
        <div className='relative bg-white rounded-2xl shadow-2xl w-full max-w-lg animate-fad-in' onClick={(e)=>e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmit} className='p-6 space-y-5'>
                ...
                <div className='flex gap-3 pt-2'>
                    ...
                    <button onClick={onClose} type='submit' disabled={loading} className='btn-primary flex-1 flex items-center justify-center gap-2'>
...
export default ApplyLeavelModal
