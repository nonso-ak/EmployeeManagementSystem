        ...
        <div className='card p-5 sm:p-6'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
                ...
                <div>
                    ...
                    <input type="number" name="basicSalary" required min="0" setp="0.01" defaultValue={initialData?.basicSalary || 0}/>
                </div>
                <div>
                    <label className='block mb-2'>Allowances</label>
                    <input type="number" name="allowances" min="0" step="0.01" required defaultValue={initialData?.allowances}/>
                </div>
                <div>
                    <label className='block mb-2'>Deductions</label>
                    <input type="number" name="deductions" min="0" step="0.01" required defaultValue={initialData?.deductions} />
                </div>
                {isEditMode && (
                    <div>
